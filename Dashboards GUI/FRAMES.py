...
label = create_widget(frame, tk.Label, text='Algos de compras', font='50', bg='lightblue', bd=3, cursor='hand2',
                      highlightcolor='red', highlightthickness=2, highlightbackground='black', 
                      relief=tk.RAISED)
label.pack()
...
# Create buttons
buttons_info = [("Compras", "Green"), ("Ventas", "Reed"), ("Algos Vivos Compras", "Green"), 
                ("Algos Vivos Ventas", "Reed"), ("Geeks5", "green"), ("Geeks6", "green")]

...
#RAZONES#
#ESGMEXMid=(TickerESGMEX["previousClose"]+TickerESGMEX["previousClose"])/2
#MextacMid=(TICKERMEXTRAC["previousClose"]+TICKERMEXTRAC["previousClose"])/2
#VmexMid=(TICKERVMEX["bid"]+TICKERVMEX["ask"])/2
#FibraMid=(TickerFIBRA["previousClose"]+TickerFIBRA["previousClose"])/2
#NaftracMid=(TickerNaftrac["previousClose"]+TickerNaftrac["previousClose"])/2
#Funo11Mid=(TickerFuno11["previousClose"]+TickerFuno11["previousClose"])/2

ESGMEXMid=(48.79*2)/2
MextacMid=(52.99*2)/2
VmexMid=(43.87*2)/2
FibraMid=(20.93*2)/2
NaftracMid=(54.27*2)/2
Funo11Mid=(22.93*2)/2
...
Fil5=OperacionesTracker.insert("","end",values=("1787"," MEXTRAC",format_int_with_commas(SaldosCuentas["Saldo"][5]),"50,000","0","0","400","33","50"),tags=("COMPRAS"))
...
def UpdateTime():
    ...
    SaldoESGMEX=Saldito(SaldosCuentas["Saldo"][2],TrackersDF["SIZES"]["1796"],IndicativoVTAESGMEX,IndicativoCPAESG,ESGMEXCOMPRASTracker["Operado FIX"][0],ESGMEXVENTASTracker["Operado FIX"][0])
    ...
    PreciosCanastas.set(Fil9,"REDENCIONES",round(IndicativoVTAFIBRATC,2))

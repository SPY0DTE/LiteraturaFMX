...
Html_VMEX=requests.get("https://biva.mx/empresas/emisoras_inscritas/banco_de_informacion?tipoInstrumento=&tipoInformacion=&type=null&tipoDocumento=&fechaInicio=&fechaFin=&emisora_id=2746&periodo=&ejercicio=&page=1").text
...
open(Direccion+"\\CANASTAS\\"+Filename+".xls","wb").write(r.content)
try: 
    os.remove(Direccion+"\\CANASTAS\\MEXTRAC1.csv")
    os.remove(Direccion+"\\CANASTAS\\ESGMEX1.csv")
    os.remove(Direccion+"\\CANASTAS\\FIBRA1.csv")
    os.remove(Direccion+"\\CANASTAS\\NAFTRAC1.csv")
    os.remove(Direccion+"\\CANASTAS\\QVGMEX1.csv")
    os.remove(Direccion+"\\CANASTAS\\VMEX1.csv")
except:
    print("Todo se ve limpio")
else:
    os.remove(Direccion+"\\CANASTAS\\MEXTRAC1.csv")
    os.remove(Direccion+"\\CANASTAS\\ESGMEX1.csv")
    os.remove(Direccion+"\\CANASTAS\\FIBRA1.csv")
